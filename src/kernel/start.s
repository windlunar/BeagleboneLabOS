...
_start:
	 ...
	 * 
	 * 所以當觸發 svc中斷時, 系統會先根據exception vector去 0x9ff52024這個位址拿svc_handler的
	 * entry addr 
	 * */ 
...
/****************************************************************************************/
// 設定 svc_handler ,irq_handler的 entry位址
/****************************************************************************************/
	ldr r0, =0x9ff52024
...
// 設定 svc stack top	
/****************************************************************************************/
	ldr sp, =0x9df40000			//svc's sp = 0x9df40000
    add r1, sp, #STACK_SIZE		//Now r1 = 0x9df41000
...
/****************************************************************************************/
    mov r2, #0x12 		
    msr cpsr_cxsf, r2
    mov sp, r1					//irq's sp = 0x9df41000
    add r1, sp, #STACK_SIZE		//Now r1 = 0x9df42000
